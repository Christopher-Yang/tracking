...
block_name = {'B1_baseline','B3','B20','B35','B49','B51_habit'};
graph_name = {'Baseline','Early','Day 4','Day 7','Day 10','Flip 1'};
...
% time = 60; %in seconds
% block_name = {'B1_baseline','B3','B5','B9','B11_habit'};
% graph_name = {'Baseline','Early','Day 1','Day 2','Flip 1 (F)'};
% % block_name = {'B2_darkBaseline','B6_dark','B10_dark'};
% % graph_name = {'Baseline','Day 1','Day 2'};
% subj_name = {'subj1','subj2','subj3','subj4','subj5','subj6','subj7','subj8','subj10','subj11','subj12','subj13','subj14'};
% remove = 0;
% d = load_data(subj_name,block_name,folder,time,remove);
% rotate = 0;
% data = analyze_data(d,block_name,0,rotate);
